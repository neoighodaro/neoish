    ...
    <DefaultLayout>
      ...
      <div className="pt-12 md:pt-16">
        <nav className="sm:hidden flex">
          <Link href='/posts'>
            <a title="Posts" className="flex items-center text-sm leading-5 font-medium dark-mode:text-gray-400 text-gray-700 hover:text-indigo-500 transition duration-150 ease-in-out">
        ...
        <nav className="hidden sm:flex items-center text-sm leading-5 font-medium">
          <Link href='/'>        
           <a href="/" className="dark-mode:text-gray-400 text-gray-700 hover:text-indigo-700 transition duration-150 ease-in-out">Home</a>
          </Link>            
          ...
          <Link href='/posts'>
            <a title="Posts" className="dark-mode:text-gray-400 text-gray-700 hover:text-indigo-700 transition duration-150 ease-in-out">Posts</a>
          </Link>
          <svg className="flex-shrink-0 mx-2 h-5 w-5 dark-mode:text-gray-600 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
          </svg>
