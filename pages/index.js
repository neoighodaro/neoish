...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Neo Ighodaro – Software Engineer</title>
      </Head>
        ...
        <header className="flex flex-col pt-16 md:pt-32 pb-10 justify-start">
          ...
          <div className="mt-4 md:mt-8">
            <div className="flex justify-center md:justify-start md:items-start md:order-2">
              ...
              <a href="&#109;&#97;&#105;&#108;&#116;&#111;&#58;%6E%65%6F%40%6E%65%6F%69%2E%73%68" target="_blank" rel="noopener" title="GitHub" className="ml-3 text-gray-400 hover:text-gray-500">
